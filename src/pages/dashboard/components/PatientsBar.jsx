  ...
  return (
    <main className="w-full  rounded-[16px] bg-[#FFFFFF] pb-[1rem] ">
      <div className=" flex flex-col gap-4">
        <div className=" w-full flex items-center justify-between gap-4 px-4 py-5">
          <h2 className="text-[24px] font-bold text-[#072635]">Patients</h2>
          <img src="/assets/search_FILL0_wght300_GRAD0_opsz24.svg" alt="" />
        </div>
        <div className="relative flex flex-col gap-0 h-[75vh] overflow-y-auto items-start justify-between pr-4">
          {users.map((user, index) => {
            return (
              <div
                key={"user" + index}
                className={`cursor-pointer w-full flex items-center justify-between hover:bg-[#D8FCF7] hover:pr-3 hover:rounded-md py- px-4 ${
